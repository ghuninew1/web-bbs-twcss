const Hader = () => {
    return (
        <div className="hidden md:flex flex-col justify-between items-center h-[70px] w-full mx-auto bg-black antialiased">
            ...
            <h1 className="text-white text-center text-[25px] font-font1 tracking-wide animate-fadeInDown">
                Create{" "}
